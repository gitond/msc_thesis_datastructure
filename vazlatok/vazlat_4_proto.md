...
## 4.1 (Our Prototype: Need and User-perspective)

[](Purpose_of_the_Prototype_&_Research_Motivation_BEGINNING)
Justication for RQ2 should be included in this chapter [](From_OLD4.1)  
RQ2: can such a system be used in cooking? [](From_OLD4.1)
...
[](User-Perspective_Description_of_the_Application_BEGINNING)
 ...
 - Goal: offer **real-time** guidance for **actions** involved in making the dish [](From_OLD4.1)
 ...
 - Similar step-by-step approach as other prototypes in the education field [](From_OLD4.1)
...
[](Challenge2:_Data_availability_and_recipe_design)
 ...
 - Data Specificity (coco has relevant labels bowl, apple, orange, banana) but it also has a million other categories unrelated to our wants. There exist application specific datasets (Lakshay Tyagi Fruit detection dataset), however if we choose to track objects outside of their domain, they are no longer enough [](From_OLD4.2)
 - No need for costly data creation stage: MS COCO already has suitable data [](From_OLD5.1)
...
[](Ready_parts)
 ...
 - (estrada) use MobileNet-SSD v2 for tracking in their application [](From_OLD4.3)
 - Tensorflow used for training CV module. Specifically MobileNet-SSD v2. [](From_OLD5.3)

[](Future_parts)

 - trained model to tf.js conversion [](From_OLD5.3)
...
## 4.4 How Technical Challenges Affected Experimental Setup
